...
public class Tabuleiro {
	...
	public Tabuleiro(int linhas, int colunas) {
		if (linhas < 1 || colunas < 1) {
			throw new ExcecaoTabuleiro("Erro criando tabuleiro, e necessario que haja pelo menos 1 linha e 1 coluna");
		}
		this.linhas = linhas;
	...
	public Peça peça(int linha, int coluna) {
		if (!posicaoExistente(linha, coluna)) {
			throw new ExcecaoTabuleiro("Posicao inexistente no tabuleiro");
		}
